...
var Botkit = require('botkit'),
    mongoStorage = require('botkit-storage-mongo')({mongoUri: process.env.mongo_url, tables: [process.env.table_publishers, process.env.table_subscribers, process.env.table_notifications, process.env.table_mailupdate]});
